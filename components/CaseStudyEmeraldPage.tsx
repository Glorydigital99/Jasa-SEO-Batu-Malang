...
interface CaseStudyEmeraldPageProps {
  onBack: () => void;
}

const CaseStudyEmeraldPage: React.FC<CaseStudyEmeraldPageProps> = ({ onBack }) => {
  return (
      ...
      <div className="space-y-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="rounded-[3rem] overflow-hidden shadow-2xl border border-white/10">
            <img 
              src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&q=75&w=800" 
...
export default CaseStudyEmeraldPage;
